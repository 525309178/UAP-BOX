...
from Attacks.Generator import weights_init
...
parser.add_argument('--imagenetTrain', type=str, default='E:\\dataset\\ImageNet\\val\\val_sub', help='ImageNet train root')
parser.add_argument('--imagenetVal', type=str, default='E:\\dataset\\ImageNet\\val\\val_sub', help='ImageNet val root')
